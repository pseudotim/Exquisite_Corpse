...
const HEAD_CONTENT = 330, TORSO_CONTENT = 360, LEGS_CONTENT = 398;
canvas.width = 850;
canvas.height = HEAD_CONTENT + TORSO_CONTENT + LEGS_CONTENT;
    ...
    (async () => {
      ...
      const legs  = await load(finalCreature.legs);
        ...
        ctx.drawImage(torso, 0,  2, 850, 360, 0, HEAD_CONTENT, 850, TORSO_CONTENT);
        ctx.drawImage(legs,  0,  4, 850, 398, 0, HEAD_CONTENT + TORSO_CONTENT, 850, LEGS_CONTENT);
